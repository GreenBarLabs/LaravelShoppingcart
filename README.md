## LaravelShoppingcart
[![Build Status](https://travis-ci.org/GreenBarLabs/LaravelShoppingcart.png?branch=master)](https://travis-ci.org/GreenBarLabs/LaravelShoppingcart)
[![Total Downloads](https://poser.pugx.org/GreenBarLabs/shoppingcart/downloads.png)](https://packagist.org/packages/GreenBarLabs/shoppingcart)
[![Latest Stable Version](https://poser.pugx.org/GreenBarLabs/shoppingcart/v/stable)](https://packagist.org/packages/GreenBarLabs/shoppingcart)
[![Latest Unstable Version](https://poser.pugx.org/GreenBarLabs/shoppingcart/v/unstable)](https://packagist.org/packages/GreenBarLabs/shoppingcart)
[![License](https://poser.pugx.org/GreenBarLabs/shoppingcart/license)](https://packagist.org/packages/GreenBarLabs/shoppingcart)
...
Run the Composer require command from the Terminal:
    ...
    composer require GreenBarLabs/shoppingcart
